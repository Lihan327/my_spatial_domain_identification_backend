"""Pipeline v10: use K=7 for all + multi-scale + ensemble + post-processing."""
import sys
sys.path.insert(0, '.')
import warnings
...
def process_slice(sid, data_root='DLPFC', out_root='DLPFC/DLPFC_result',
                  ...
                  n_pca=30, K=7, n_seeds_gmm=5, post_iter=2):
    print(f"\n========== {sid} ==========")
    t0 = time.time()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--csv_path', default='results/HSGATE-v10_per_slice_metrics.csv')
